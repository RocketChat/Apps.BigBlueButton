...
// Felipe asked me to remove this because the app is supposed to send notifications only once a week
// which isnt too much to make a stop notification slash command
